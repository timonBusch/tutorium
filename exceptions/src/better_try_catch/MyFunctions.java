...
public class MyFunctions {
     ...
     * @param y Nenner
     * @return Result
     * @throws ArithmeticException Wenn es bei der Berechnung zu mathematischen Problemen gekommen
     *     ist
     */
     ...
     * @return Array mit allen Files des Verzeichnisses
    ...
    /**
     * Gibt ein zufälliges .txt File aus dem übergebenen File-Array zurück
     *
     * @param files Das File-Array aus dem die .txt ausgewählt werden soll
    ...
    /**
     * Gibt die erste (zusammenhängende) Zahl zurück, die im String gefunden wird.
     *
